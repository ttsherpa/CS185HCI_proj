...
export class RegisterComponent implements OnInit {
  ...
  uploader: CloudinaryUploader = new CloudinaryUploader(
    new CloudinaryOptions({ cloudName: 'dq1mmejw4', uploadPreset: 'myUnsignedPreset' }));
  ...
  constructor(
    ...
    this.cropperSettings2.cropperDrawSettings.strokeColor = '#2c3e50';
